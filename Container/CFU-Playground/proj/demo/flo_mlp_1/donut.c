...
void forward(int *input, int *output, int w1[][38], int w2[3][50], int num, int b1[50], int b2[3]) {
    ...
    for (int i = 0; i < 50; i++) {  // Iterate over 4 neurons in the dense layer
        dense_output[i] = b1[i];
    	for (int j = 0; j < 38; j=j+2) {
	    a = 0;
            b = 0;
